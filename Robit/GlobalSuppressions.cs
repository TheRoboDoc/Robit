...
[assembly: SuppressMessage("Style", "IDE1006:Naming Styles", Justification = "Cannot rename as a lot of recorded response entries exist and renaming would require rewriting of a lot of JSON entries", Scope = "member", Target = "~P:Robit.Command.SlashCommands.QuoteEntry.author")]
[assembly: SuppressMessage("Style", "IDE1006:Naming Styles", Justification = "Cannot rename as a lot of recorded response entries exist and renaming would require rewriting of a lot of JSON entries", Scope = "member", Target = "~P:Robit.Command.SlashCommands.QuoteEntry.bookSource")]
[assembly: SuppressMessage("Style", "IDE1006:Naming Styles", Justification = "Cannot rename as a lot of recorded response entries exist and renaming would require rewriting of a lot of JSON entries", Scope = "member", Target = "~P:Robit.Command.SlashCommands.QuoteEntry.quote")]
